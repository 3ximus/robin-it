...
class Ui_show_window(object):
    def setupUi(self, show_window):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 543, 198))
        ...
        self.horizontalLayout_8.addWidget(self.refresh_button)
        ...
        self.refresh_button_2 = QtWidgets.QPushButton(self.centralwidget)
        self.refresh_button_2.setMaximumSize(QtCore.QSize(30, 30))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.ButtonText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.ButtonText, brush)
        self.refresh_button_2.setPalette(palette)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_9.addWidget(self.refresh_button_2)
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 1055, 228))
    ...
    def retranslateUi(self, show_window):
        ...
        self.refresh_button.setText(_translate("show_window", "↻"))
        self.episodes_label.setText(_translate("show_window", "< episodes >"))
        self.refresh_button_2.setText(_translate("show_window", "↻"))
