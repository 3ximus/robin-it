...
class Ui_show_window(object):
    def setupUi(self, show_window):
        ...
        self.showname_label_2 = QtWidgets.QLabel(self.centralwidget)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.showname_label_2.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Hack")
        ...
        font.setItalic(False)
        font.setWeight(75)
        self.showname_label_2.setFont(font)
        self.showname_label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.showname_label_2.setObjectName("showname_label_2")
        self.verticalLayout.addWidget(self.showname_label_2)
    ...
    def retranslateUi(self, show_window):
        ...
        self.showname_label_2.setText(_translate("show_window", "> network"))
