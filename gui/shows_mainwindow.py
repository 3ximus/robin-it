...
class Ui_shows_mainwindow(object):
    def setupUi(self, shows_mainwindow):
        ...
        self.shows_label_2 = QtWidgets.QLabel(self.page_2)
        self.shows_label_2.setGeometry(QtCore.QRect(40, 20, 901, 174))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.ToolTipText, brush)
        self.shows_label_2.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono Medium for Powerline")
        font.setPointSize(62)
        font.setItalic(False)
        self.shows_label_2.setFont(font)
        self.shows_label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.shows_label_2.setObjectName("shows_label_2")
    ...
    def retranslateUi(self, shows_mainwindow):
        ...
        self.shows_label_2.setText(_translate("shows_mainwindow", "results..."))
