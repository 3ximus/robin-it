...
class Ui_loginwindow(object):
    def setupUi(self, loginwindow):
        ...
        self.login_box.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.login_box.setText("")
        self.login_box.setObjectName("login_box")
        self.horizontalLayout.addWidget(self.login_box)
        self.loggin_button = QtWidgets.QPushButton(self.centralwidget)
        self.loggin_button.setMaximumSize(QtCore.QSize(40, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.loggin_button.setFont(font)
        self.loggin_button.setChecked(False)
        self.loggin_button.setFlat(False)
        self.loggin_button.setObjectName("loggin_button")
        self.horizontalLayout.addWidget(self.loggin_button)
    ...
    def retranslateUi(self, loginwindow):
        ...
        self.loggin_button.setText(_translate("loginwindow", ">>"))
